...
class PointResidualCoder(object):
    ...
    def encode_torch(self, gt_boxes, points, gt_classes=None):
        ...
        Returns:
            box_coding: (N, 8 + C)
        """
        self.mean_size = self.mean_size.to(gt_boxes.device) # ensure multi-gpu training works
    ...
    def decode_torch(self, box_encodings, points, pred_classes=None):
        ...
        self.mean_size = self.mean_size.to(points.device) # ensure multi-gpu training works
